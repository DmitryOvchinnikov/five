...
curl-create:
	curl -il -X POST -H 'Content-Type: application/json' -d '{"name":"dmitry","email":"d@gmail.com","roles":["ADMIN"],"department":"IT","password":"123","passwordConfirm":"123"}' http://localhost:3000/v1/users
...
KIND_CLUSTER    := dmitry-starter-cluster
NAMESPACE       := sales-system
APP             := sales
BASE_IMAGE_NAME := dmitryworkshop/service
